import { ChatMessage, ChatSession, Conversation } from "../types";
  ...
  conv_1: [
    {
      id: "1",
      sender: "mentor",
      text: "Chào em, anh có thể giúp gì cho em?",
      createdAt: Date.now() - 1000 * 60 * 60,
    },
    {
      id: "2",
      sender: "mentee",
      text: "Em muốn hỏi về buổi học ngày mai ạ",
      createdAt: Date.now() - 1000 * 60 * 30,
    },
    {
      id: "3",
      sender: "mentor",
      text: "Buổi học đó mình sẽ tập trung vào React Native nhé.",
  ...
  conv_2: [
    {
      id: "1",
      sender: "mentor",
      text: "Chào em, xác nhận lịch hẹn lúc 2h chiều nay nhé.",
