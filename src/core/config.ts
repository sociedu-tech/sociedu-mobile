...
const resolvedApiBaseUrl = rawApiBaseUrl ?? 'https://vietdemo.com/api_mentor';
...
export const API_BASE_URL = BACKEND_CONFIG.baseUrl;
export const USE_MOCK =
  parseBoolean(getEnvValue('EXPO_PUBLIC_USE_MOCK')) || !rawApiBaseUrl;
